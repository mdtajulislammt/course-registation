...
const CartContainer = ({addItem,remaining,totalCredit,totalPrice}) => {
     ...
     return (
          <>
               ...
               <h1 className=" text-lg font-bold mb-5 text-[#2F80ED] ">Credit Hour Remaining {remaining} hr</h1>
               <hr />
               ...
               <hr />
               <h2 className=" text-lg font-medium mt-4 mb-4">Total Credit Hour : {totalCredit}</h2>
               <hr />

               <h2 className=" text-lg font-semibold mt-4 ">Total Price : {totalPrice} USD</h2>
